...
public class RemoteAddress {
    ...
    static final String HTTP_HEADER_QUIDSI_CLIENT_IP = "client-ip";

    public static RemoteAddress create(HttpServletRequest request) {
        String directRemoteAddress = request.getRemoteAddr();
        String clientIpHeader = request.getHeader(HTTP_HEADER_QUIDSI_CLIENT_IP); // quidsi netscaler doesn't use x-forwarded-for
